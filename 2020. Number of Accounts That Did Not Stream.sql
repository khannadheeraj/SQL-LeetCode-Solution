...
Each row of this table indicates the start and end dates of an account subscription.
...
from (
    select b.stream_date as date_to_check
    from Subscriptions as a
    join Streams as b
    on a.account_id=b.account_id 
    where year(a.start_date)=2021 or year(a.end_date)=2021
) as t
where  year(t.date_to_check) != 2021
